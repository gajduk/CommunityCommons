...
public class StringUtils
{
	...
	public static void base64DecodeToFile(IContext context, String encoded, IMendixObject targetFile) throws Exception
	{
		if (targetFile == null)
		...
		Core.storeFileDocumentContent(context, targetFile, new ByteArrayInputStream(decoded));
	}
	...
	public static String base64EncodeFile(IContext context, IFileDocument file) throws IOException
	{
		if (file == null)
			throw new IllegalArgumentException("Source file is null");
	...
	public static String stringFromFile(IContext context, IFileDocument source) throws IOException
	{
		if (source == null)
			return null;
	...
	public static void stringToFile(IContext context, String value, IFileDocument destination)
	{
		if (destination == null)
	...
	public static String XSSSanitize(String html, String policy_string)
			throws Exception {
		if (html == null)
			return "";
		// return HtmlSanitizer.sanitize(html);
		if ( policy_string == null ) policy_string = "tinymce";
		else policy_string = policy_string.toLowerCase();
